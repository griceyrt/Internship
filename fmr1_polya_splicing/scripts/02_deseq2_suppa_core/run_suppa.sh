...
# =============================================================================
# SUPPA splicing pipeline for GSE188840. 2 conditions (WT, KO), 3 reps each.
# TPM matrix comes from normalisation_deseq2_oarfish.R's tximport export.
# GTF is the stock mm39 Ensembl annotation. Boundary mode fixed at V/1nt.
# All 7 event types tested separately, not pooled.
# =============================================================================
