...
# Saved to file (not just printed) since the Venn diagram script needs
# this total as a reproducible input, not a manually-copied console number.
write.table(
  data.frame(metric = "n_deseq2_significant_genes_padj0.05",
             value  = length(deseq_sig_genes)),
  file      = file.path(OUTPUT_DIR, "overlap1_deseq2_total_sig_genes.tsv"),
