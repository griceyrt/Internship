...
do
    ...
    # Skip if this sample already finished (sorted+indexed BAM exists) --
    # lets the job be safely resubmitted after a cancel/timeout without
    # redoing already-completed samples.
