...
# Author: Gricey
# Adapted from: GSE133398_normalisation_deseq2.R (gene-level pattern, per
#               Lies's call on the 2026-07-29 Zoom that DESeq2's level
#               doesn't matter for SUPPA, since SUPPA's TPM comes from the
#               quantifier directly, not from DESeq2's output)
#
# Dataset: GSE188840 -- WT vs Fmr1 KO mouse brain cortex, ONT direct RNA-seq
#   WT (n=3): WT_Rep1, WT_Rep2, WT_Rep3
#   KO (n=3): KO_Rep1, KO_Rep2, KO_Rep3
#
# Quantifier: oarfish, not Salmon -- decided 2026-08-04 (Salmon 2.x's own
#   --ont flag says "not supported, use oarfish instead"), validated against
#   all 6 samples. tximport has native oarfish support (type = "oarfish").
#
