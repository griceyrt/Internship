...
combine_htseq_counts.py. A high "ambiguous"/"not_unique" rate is relevant to
whether the 3'UTR/5' boundary extension is inflating misassignment.
Author: Gricey
...
Example:
    python3 analyze_htseq_qc.py \
        results/GSE130613/SRP194523_star_htseq_2026-07-17/combined_htseq_qc_counters.tsv \
        results/GSE130613/SRP194523_star_htseq_2026-07-17/combined_gene_counts.tsv
