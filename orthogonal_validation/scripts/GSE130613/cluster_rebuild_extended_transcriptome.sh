...
# (extended 1000bp toward 5', 100bp toward 3', matching Asher's own MARS-seq
# processing approach). Genome FASTA is reconstructed from gentrome_ext.fa's
# decoy sequences rather than re-transferring 2.7GB from the Mac.
#
