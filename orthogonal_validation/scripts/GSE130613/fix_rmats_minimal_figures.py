#!/usr/bin/env python3
"""
Fixes for the two rMATS minimal volcano SVGs only (p0.3 and FDR0.05), vs
make_final_figures_GSE130613_new_pipeline.py: background scatter now fully
vector (was rasterized, looked pixelated zoomed in Inkscape), explicit sparse
tick marks instead of matplotlib's denser auto ticks.
Author: Gricey
