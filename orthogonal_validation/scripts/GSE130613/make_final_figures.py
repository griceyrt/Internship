#!/usr/bin/env python3
"""
Final publication-ready figures for Orthogonal Validation. Output:
results/GSE130613/figures/figures_final/. Format: SVG (vector), Arial font, no title,
no legend, bare-minimum axes. A companion legend.txt explains colors and
thresholds.
Author: Gricey
"""
...
SUPPA_DIR = os.path.join(BASE, "results", "GSE130613", "suppa_2026-06-20", "diff")
NAN_DIR   = os.path.join(BASE, "data", "nanopore_suppa")
DESEQ     = os.path.join(BASE, "results", "GSE130613", "normalisation", "deseq2_KO_vs_WT.tsv")
KHUSHI    = os.path.join(BASE, "data", "Table3-differential_expressiong_WTvsPerKO.xlsx")
OUT       = os.path.join(BASE, "results", "GSE130613", "figures", "figures_from_script")
