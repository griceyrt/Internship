#!/bin/bash
# SUPPA pipeline -- Orthogonal Validation Project 2 (generateEvents,
# psiPerEvent, split by condition, diffSplice, WT CT16-20 vs KO CT16-20).
...
NORM_TABLE="${BASE_DIR}/results/GSE130613/normalisation/combined_norm.tab"

OUTDIR="${BASE_DIR}/results/GSE130613/suppa_$(date +%Y-%m-%d)"
mkdir -p "${OUTDIR}"
