"""
Verifies the final STAR+htseq-count (original GTF) numbers and their overlap
with Nanopore (direction concordance). Produces console output and an Excel
workbook (verify_final_numbers.xlsx, 3 sheets: Summary with live
COUNTIFS/SUMPRODUCT formulas, All_STAR_htseq_genes, Nanopore_overlap).
Author: Gricey
...
LFC_THRESH = 0.5
PADJ_THRESH = 0.05
OUT_XLSX = "results/GSE130613/marsseq_sanity_check/verify_final_numbers.xlsx"
...
star = pd.read_csv("results/GSE130613/normalisation_star_htseq_original_gtf/deseq2_star_htseq_KO_vs_WT.tsv", sep="\t")
