#!/usr/bin/env Rscript
# GSE133398 -- Option B: transcript-level DESeq2 + stageR (vs Option A,
# gene-level, in GSE133398_normalisation_deseq2.R). perGeneQValueHack/
# perGeneQValueExact are Bharath's, verbatim from the GSE130613 script.
# Author: Gricey
...
OUTPUT_DIR  <- file.path(BASE_DIR, "results", "GSE133398", "normalisation_GSE133398_stageR")
