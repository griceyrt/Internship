#!/bin/bash
# =============================================================================
# GSE133398 SUPPA Pipeline
# Author: Gricey
# Adapted from: run_suppa.sh (GSE130613)
#
# Dataset: GSE133398 — SRSF3 KO vs control hepatocytes
#   WT = GFP control (columns 1-4 in combined_norm.tab)
#   KO = CRE / SRSF3 KO (columns 5-8 in combined_norm.tab)
#
# Steps:
#   7.  generateEvents from custom GTF (strict boundary -b S)
#   9.  psiPerEvent
#   10a. Split PSI and expression tables by condition
#   10b. diffSplice (empirical, -gc)
#
...
NORM_TABLE="${BASE_DIR}/results/normalisation_GSE133398/combined_norm.tab"
OUTDIR="${BASE_DIR}/results/suppa_GSE133398_$(date +%Y-%m-%d)"
mkdir -p "${OUTDIR}"
...
# =============================================================================
# STEP 8 — confirm expression table exists
# =============================================================================
