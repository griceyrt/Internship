#!/usr/bin/env python3
"""
Publication-ready restyle of the GSE130613 (Asher) figures under results/figures/,
...
Overwrites, in results/figures/ (both .svg and .png):
...
DESEQ_NEW  = os.path.join(BASE_DIR, "results", "normalisation_star_htseq_original_gtf", "deseq2_star_htseq_KO_vs_WT.tsv")
...
OUT        = os.path.join(BASE_DIR, "results", "figures")
