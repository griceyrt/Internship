...
# Author: Gricey
# Run from orthogonal_validation/: Rscript scripts/fig1c_overlap_timecourse_dtu14genes.R
...
gene_list <- read.csv(paste(out_dir, "csv/dtu14_genes_list.csv", sep = ""))$gene_id
length(gene_list)  # 14
