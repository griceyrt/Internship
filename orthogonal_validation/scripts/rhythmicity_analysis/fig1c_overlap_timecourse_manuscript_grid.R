...
# Author: Gricey
# Run from orthogonal_validation/: Rscript scripts/rhythmicity_analysis/fig1c_overlap_timecourse_manuscript_grid.R
...
tx_ids <- tx2gene %>% filter(gene_id %in% gene_ids) %>% pull(transcript_id)
