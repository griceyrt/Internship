...
# Filtered version of ../fig1c_isoform_timecourse_lostgenes.R -- restricts
# tx_ids to expressed transcripts (>5 reads in >=2 WT samples), same
# definition as tx_to_gene_rhythmicity.R (Khushi, 2026-08-20 email).
# Author: Gricey
# Run from orthogonal_validation/: Rscript scripts/rhythmicity_analysis/rhythmicity_filtered/fig1c_isoform_timecourse_lostgenes.R
